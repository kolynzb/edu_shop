...
const Navbar = (props) => {
  ...
  useEffect(() => {
    window.addEventListener("scroll", () => {
      window.scrollY > 100 ? setNavShow(true) : setNavShow(false);
    });
  }, []);
  return (
    <>
      <div className={`navbar ${navShow && "navColor"}`}>
...
const NavBottom = (props) => (
  <ul className={`navbottom  ${props.navShow && "navtransform"}`}>
...
const TotopBtn = () => (
  <div className="totopbtn" onClick={totop}>
    <svg
      stroke="currentColor"
      fill="currentColor"
      stroke-width="0"
